...
Нештатные ситуации с антенно-фидерным трактом могут происходить у различных эксплуатантов радиоэлектронной аппаратуры. При её эксплуатации могут возникнуть описанные выше явления, требующие своевременной реакции. Ниже приведен перечень направлений прикладного использования, где применяется коротковолновая радиосвязь и может быть применена защита АФУ на основе разработанной библиотеки:
...
файлом **PanoramaKCommon.h**, этот файл содержит определения типов использующихся в интерфейсе библиотеки. Если проект
программы для библиотеки Panorama-K написан на С++17 и [фрэймворке Qt5/Qt6](https://www.qt.io/), тогда библиотеку можно
...
скомпилированной динамической библиотеки при запуске и с подключением библиотеки в виде исходных текстов.
